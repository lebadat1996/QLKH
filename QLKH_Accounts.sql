...
CREATE TABLE `Accounts` (
  ...
  KEY `fk_account` (`customer_number`),
  CONSTRAINT `Accounts_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `Customers` (`customer_number`),
...
-- Dump completed on 2020-05-04 17:01:27
